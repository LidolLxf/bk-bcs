...
platform-manager:pre
	...
	cd ${BCS_SERVICES_PATH}/bcs-platform-manager && go mod tidy && CGO_ENABLED=0 go build ${LDFLAG} -o ${WORKSPACE}/${PACKAGEPATH}/bcs-services/bcs-platform-manager/bcs-platform-manager ./main.go
