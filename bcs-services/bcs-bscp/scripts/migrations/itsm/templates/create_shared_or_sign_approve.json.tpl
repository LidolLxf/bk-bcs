{
	"is_deleted": false,
	"name": "\u521b\u5efa\u5171\u4eab\u96c6\u7fa4\u547d\u540d\u7a7a\u95f4-20240308112119-20240914173410-20240914175319-20240920152131",
	"desc": "",
	"flow_type": "other",
	"is_enabled": true,
	"is_revocable": true,
	...
	"states": {
		...
		"445": {
			...
			"extras": {
				"webhook_info": {
					"method": "POST",
					"url": "https://bcs-api-gateway.bcs-system.svc.cluster.local/api/v1/config/biz_id/{{BIZ_ID}}/app_id/{{APP_ID}}/release_id/{{RELEASE_ID}}/approve",
					"query_params": [],
					"auth": {
						"auth_type": "bearer_token",
						"auth_config": {
					...
					"headers": [{
						"check": true,
						"key": "X-Bkapi-Authorization",
						"value": "{\"bk_app_code\": \"bk-bscp\", \"bk_app_secret\": \"AWy9VhpNoEQ4U6STq3p5XRVxWcuOOceTTEVh\"}",
						"desc": "",
						"select": true
					}],
					"body": {
